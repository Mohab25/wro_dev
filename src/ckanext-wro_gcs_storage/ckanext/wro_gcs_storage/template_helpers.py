...
def resource_read_helper(data_dict:dict):
    ...
    full_url = f'https://storage.cloud.google.com/{bucket_name}/{package_name}/'+ cloud_path+ '/'+ pathlib.Path(resource['name']).stem + '_id_' + id + pathlib.Path(resource['name']).suffix
